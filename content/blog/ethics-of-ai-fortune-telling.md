---
title: "The ethics of AI fortune-telling"
slug: "ethics-of-ai-fortune-telling"
description: "Do not predict events, do not make medical or financial claims, do not manipulate vulnerable users, do not retain biometric data without consent. The ethics of AI fortune-telling, plainly stated."
keyword: "ethics of AI fortune telling"
date_published: "2026-05-16"
bluf: "The ethics of AI fortune-telling are simpler than they sound: do not predict events, do not make medical or financial claims, do not manipulate vulnerable users, do not retain biometric data without clear consent, and do not pretend that a disclaimer in fine print substitutes for honest framing throughout. PalmAura is built around these principles deliberately, and the principles are the right floor for the whole category."
faqs:
  - q: "Is AI fortune-telling ethical?"
    a: "It depends entirely on how the app is built. AI fortune-telling that is honest about being symbolic, refuses medical/financial claims, protects user data, and avoids manipulating vulnerable users is ethical. AI fortune-telling that pretends to predict events, plays on credulity, gates fortunes behind subscriptions, or shares user photos with third parties is not."
  - q: "What are the biggest risks of AI palm reading apps?"
    a: "Four main risks: overpromising prediction (claiming to forecast events the app cannot forecast), making medical/legal/financial claims it has no basis for, retaining or sharing user photos without clear consent, and using manipulative monetisation patterns (urgency, scarcity, fear) on vulnerable users."
  - q: "Why are entertainment-only disclaimers not enough on their own?"
    a: "A disclaimer in fine print does not undo a reading that has been written, throughout, in predictive language. If the app's interpretive copy says 'you will' and 'your future,' the disclaimer at the bottom of the screen is contradicted by the body of the experience. Honest framing has to run through the reading itself, not just appear in legal text."
...
<aside class="visual-placeholder">VISUAL: A clean typographic plate listing the five ethical principles of responsible AI fortune-telling: "Do not predict events. Do not make medical or financial claims. Do not retain biometric data without consent. Do not manipulate vulnerable users. Do not let a disclaimer substitute for honest framing." Styled as a Victorian engraving manifesto, with each principle on its own line in display type.</aside>
...
For the broader frame on what AI palm reading can and can't claim, see [are AI palm readings accurate](/blog/are-ai-palm-readings-accurate.html).
...
For the broader question of how AI is changing the practice of palmistry, see [how AI reads a palm](/blog/how-ai-palm-reading-works.html). For the historical context — palmistry as a 5,000-year tradition the current AI moment is one chapter of — see [a short history of chiromancy](/blog/history-of-palmistry.html).
